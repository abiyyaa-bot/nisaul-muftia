...
-- Password:   `password`
--
DROP DATABASE IF EXISTS nielhotel;
CREATE DATABASE IF NOT EXISTS nielhotel;

DROP USER IF EXISTS'niel_user'@'%';
CREATE USER IF NOT EXISTS 'niel_user'@'%' IDENTIFIED BY 'password';
GRANT ALL PRIVILEGES ON nielhotel.* TO 'niel_user'@'%';
USE nielhotel;
